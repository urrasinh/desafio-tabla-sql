...
CREATE TABLE comentarios (id SERIAL PRIMARY KEY, post_fk, fecha_creacion DATE, hora_creacion TIME, contenido VARCHAR(50), FOREIGN KEY (post_fk) REFERENCES post(id));
