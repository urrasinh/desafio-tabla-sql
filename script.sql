...
CREATE TABLE post (id INT, nombre_usuario VARCHAR(20), fecha_creacion DATE, contenido VARCHAR(50), descripcion VARCHAR(120), PRIMARY KEY (id));

-- Insertar 3 post, 2 para el usuario "Pamela" y uno para "Carlos".
INSERT INTO post (id, nombre_usuario, fecha_creacion, contenido, descripcion) VALUES (1, 'Pamela', '2022-04-05', 'contenido', 'observaciones bla bla' );
INSERT INTO post (id, nombre_usuario, fecha_creacion, contenido, descripcion) VALUES (2, 'Pamela', '2021-12-09', 'otro contenido', 'observaciones bla bla' );
INSERT INTO post (id, nombre_usuario, fecha_creacion, contenido, descripcion) VALUES (3, 'Carlos', '2022-03-23', 'contenido', 'observaciones bla bla' );
...
INSERT INTO post (id, nombre_usuario, fecha_creacion, contenido, descripcion, titulo) VALUES (4, 'Pedro', '2021-12-10', 'otro contenido', 'observaciones bla bla', 'titulo de ejemplo' );
INSERT INTO post (id, nombre_usuario, fecha_creacion, contenido, descripcion, titulo) VALUES (5, 'Pedro', '2022-01-01', 'contenido', 'observaciones bla bla', 'titulo de ejemplo' );

-- Eliminar el post de Carlos.
DELETE FROM post WHERE id=3;

-- Ingresar un nuevo post para el usuario "Carlos".
INSERT INTO post (id, nombre_usuario, fecha_creacion, contenido, descripcion, titulo) VALUES (6, 'Carlos', '2022-01-01', 'contenido', 'observaciones bla bla', 'titulo de ejemplo' );
